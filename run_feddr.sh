...
logfile=${cur_path}/logs/log_sgd_feddr_${dataset}_$cur_date
    ...
    do
        ...
        do
            ...
            do
                ...
                py_req="python ${cur_path}/main_fed.py --grad_norm=2 --grad_perp_norm=${gp} --local_round=2 --global_round=50 --lr=${l} --dataset=${dataset} --model=cnn --momentum=${m} --sample_ratio=${r} --num_clients=1000 --FLalg=FedDRDP";
        ...
        do
            ...
            do
                ...
                do
                    ...
                    py_req="python ${cur_path}/main_fed.py --grad_norm=2 --grad_perp_norm=${gp} --eps=${eps[${i}]} --eps_2=${eps_2[${i}]}  --local_round=2 --global_round=50 --lr=${l} --dataset=${dataset} --model=cnn  --clip_paral=${cp} --sample_ratio=${r} --num_clients=100  --FLalg=FedDRDP";
