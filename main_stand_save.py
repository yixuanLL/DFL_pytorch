...
import os
from utils.grad_plot import grad_plot, grad_var, grad_var_t, loss_plot, grad_plot_t, alpha_plot, grad_dist, grad_norm_save, grad_pca,grad_pca_vec, grad_norm_hist
...
def main(args):
    ...
    # alpha_plot(log)
    # grad_dist(log)
    grad_norm_save(log, args.dataset, DATA_MODEL[args.dataset])
    # grad_pca(log, args.dataset)
    # grad_pca_vec(log, args.dataset)
    # grad_norm_hist(log, args.dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--FLalg', type=str, default='FLamby', help='Algorithm of FL')
    ...
    parser.add_argument('--noise_multiplier_a', type=float, default=0.0)
    ...
    parser.add_argument('--grad_perp_norm', type=float, default=5)
    ...
    parser.add_argument('--steps_interval', type=int, default=39200, help='interval')
