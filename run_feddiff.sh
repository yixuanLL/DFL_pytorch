...
logfile=${cur_path}/logs/log_sgd_feddiff_${dataset}_$cur_date
    ...
    do
        ...
        do
            ...
            do
                ...
                py_req="python ${cur_path}/main_fed.py --grad_norm=2 --grad_perp_norm=${gp} --local_round=2 --global_round=50 --lr=${l} --dataset=${dataset} --model=cnn --momentum=${m} --sample_ratio=${r} --num_clients=1000 --FLalg=FedDPDIFF";
        ...
        do
            ...
            do
                ...
                do
                    ...
                    py_req="python ${cur_path}/main_fed.py --grad_perp_norm=${gp} --eps=${eps[${i}]} --local_round=2 --global_round=50 --lr=${l} --dataset=${dataset} --model=cnn  --sample_ratio=${r} --num_clients=100  --FLalg=FedDPDIFF";
