...
class Model(nn.Module):
    def __init__(self, inputdim, outputdim):
        ...
        self.layer1 = self._make_layer(16, self.num_blocks[0], stride=1)
        self.layer2 = self._make_layer(32, self.num_blocks[1], stride=2)
        self.layer3 = self._make_layer(64, self.num_blocks[2], stride=2)
        self.linear = nn.Linear(64, outputdim)
