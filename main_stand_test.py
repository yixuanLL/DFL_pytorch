...
if __name__ == '__main__':
    ...
    parser.add_argument('--noise_multiplier_g', type=float, default=2.14)
    parser.add_argument('--noise_multiplier_p', type=float, default=2.2)
    parser.add_argument('--noise_multiplier_a', type=float, default=8.0)
    parser.add_argument('--delta', type=float, default=1e-5, help='differential privacy parameter')
    parser.add_argument('--grad_norm', type=float, default=0.8)
