...
class DrOptimizerV6(DPOptimizer):
    ...
    def dr_process(self):
        paral_alpha = [torch.tensor(self.clip_paral)]*len(self.grad_samples) # use clip_paral as alpha
    ...
    def clip_and_accumulate(self):
        ...
        if len(self.grad_samples[0]) == 0:
            ...
            # print('pre clip grad norm', per_sample_norms[0:5])
        for p in self.params:
